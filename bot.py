...
# 1. നിങ്ങളുടെ ഫയർബേസ് ഡാറ്റാബേസ് URL
FIREBASE_URL = "https://a-one-chat-e3642-default-rtdb.firebaseio.com"
...
def check_total(message):
    ...
    url = f"{FIREBASE_URL}/savings/{user_id}/transactions.json"
    ...
    try:
        ...
        bot.reply_to(
            message, "❌ ഡാറ്റ എടുക്കുന്നതിൽ ചെറിയൊരു പ്രശ്നം വന്നു."
        )


# ഫയർബേസിലേക്ക് ഡാറ്റ സേവ് ചെയ്യുന്ന ഫങ്ഷൻ (REST API വഴി)
def save_to_firebase(user_id, amount):
    ...
    requests.post(url, json=new_transaction)
